...
public class Create {
    public static String getCreateMapping() throws IOException {
        XContentBuilder xBuilder = XContentFactory.jsonBuilder()
                ...
                .startObject("platform_code").field("type", "string").endObject()
                .startObject("region_code").field("type", "string").endObject()
                ...
                .startObject("is3d").field("type", "boolean").endObject()
                .startObject("time_length").field("type", "integer").endObject()
                .startObject("is_customer").field("type", "boolean").endObject()
                .startObject("star_ration").field("type", "integer").endObject()
                .startObject("zone").field("type", "string").endObject()
...
//                            .startObject("tag_arr")
                ...
                .startObject("properties")
                .startObject("tagname").field("type", "string").field("index", "not_analyzed").endObject()
                .endObject()
                .endObject()
                .endObject()
                .endObject()
